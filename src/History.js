...
class History extends Component {
  render() {
    return (
      <div>
        <h1 class="center">The Beginning</h1>
        <br></br>
        ...
        <p> The Darknet/Dark Web/Deep Web as a whole is approximately 17 times larger in size than the surface web<sup>7</sup>.
        ...
        by the website host) the Deep Web is constantly changing.  These hidden websites that exist here are hosted by individuals instead of corporations
        ...
        government censorship through Tor. They thus successfully informed the world about what was happening in Egypt (Stacey 2017).”<sup>4</sup>  This sharing and leaking
        of classified government secrets or of wrongdoings by people within authoritative positions puts any whistleblower in a dangerous often life threatening
        situation.  Famous whistleblowers like Edward Snowden come to mind here.
          </p>
